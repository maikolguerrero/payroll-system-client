...
const FormEmployees = ({ employee, onClose }) => {
  ...
  return (
    <form
      className="grid md:grid-cols-2 justify-center bg-gray-900 p-6 rounded-lg shadow-lg"
    ...
    >
      <div className="mb-4 xs:ml-4 flex justify-center">
        <div className="w-full md:w-5/6 md:ml-auto mr-8">
          ...
          <input
            ...
            className="shadow appearance-none border border-gray-600 rounded-[9px] py-2 px-4 text-gray-300 bg-gray-800 w-full focus:outline-none focus:shadow-outline"
          />
        </div>
      </div>
      ...
      <div className="mb-4 flex justify-center">
        <div className="w-full md:w-5/6 md:ml-auto mr-8">
          <label htmlFor="surnames" className="block text-sm font-medium text-gray-300 mb-2">
            Apellidos
          </label>
          <input
            type="text"
      ...
      <div className="mb-4 flex justify-center">
        <div className="w-full md:w-5/6 md:ml-auto mr-8">
          <label htmlFor="position_id" className="block text-sm font-medium text-gray-300 mb-2">
            Cargo
          </label>
          <select
            id="position_id"
      ...
      <div className="mb-4 xs:ml-4 flex justify-center">
        <div className="w-full md:w-5/6 md:ml-auto mr-8">
          <label htmlFor="base_salary" className="block text-sm font-medium text-gray-300 mb-2">
            Salario Base
          </label>
          <input
            type="number"
      ...
      <div className="mb-4 xs:ml-4 flex justify-center">
        <div className="w-full md:w-5/6 md:ml-auto mr-8">
          <label htmlFor="hire_date" className="block text-sm font-medium text-gray-300 mb-2">
            Fecha de Ingreso
          </label>
          <input
            type="date"
      ...
      <div className="mb-4 xs:ml-4 flex justify-center">
        <div className="w-full md:w-5/6 md:ml-auto mr-8">
          <label htmlFor="ci" className="block text-sm font-medium text-gray-300 mb-2">
            Cédula de Identidad
          </label>
          <input
            type="text"
