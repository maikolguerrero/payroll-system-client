        ...
        <div className="grid grid-cols-2 gap-x-12 w-full">
          ...
          <div className="mb-4">
            ...
            <input
              type="date"
              id="dateStart"
              className="shadow appearance-none border-transparent rounded-[10px] w-full py-2 px-3 text-gray-800 dark:text-gray-300 leading-tight bg-gray-300 dark:bg-gray-700"
            />
          </div>
          {/* Campo Fecha Fin */}
          <div className="mb-4">
