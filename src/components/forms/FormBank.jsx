        ...
        <div className="grid grid-cols-2 gap-x-12 w-full">
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={handleInputChange}
               className="shadow appearance-none border border-gray-300 dark:border-gray-600 rounded-[10px] w-full py-2 px-3 text-gray-800 dark:text-gray-300 leading-tight bg-gray-300 dark:bg-gray-700"
            >
          ...
          <div className="mb-4">
            ...
            <input
              type="text"
              name="account_number"
              className="shadow appearance-none border border-gray-300 dark:border-gray-600 rounded-[10px] w-full py-2 px-3 text-black dark:text-gray-300 leading-tight bg-gray-300 dark:bg-gray-700"
